                ...
                <div class="space-y-8 divide-y divide-gray-200 mt-10">
                    <form method="POST" action="{{route('admin.members.store')}}" enctype="multipart/form-data">
                      ...
                      <div class="sm:col-span-6 pt-5">
                        ...
                        <div class="mt-1">
                          <input type="number" id="telephone" name="telephone" class="block w-full transition duration-150 ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('telephone') border-red-400 @enderror" />
                        </div>
                        @error('telephone')
                        <div class="text-sm text-red-400">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="flex justify-end m-2 p-2">
                      <a href="{{route('admin.members.index')}}" class="px-4 py-2 bg-indigo-500 hover:bg-red-700 rounded-lg text-white text-white">Back</a>
                  </div>
                  </div>
            </div>
        </div>
