                ...
                <div class="space-y-8 divide-y divide-gray-200 mt-10">
                    <form method="POST" action="{{route('admin.categories.store')}}" enctype="multipart/form-data">
                      ...
                      <div class="sm:col-span-6 pt-5">
                        ...
                        <div class="mt-1">
                          <input type="number" min="0.00" max="1000.00" step="0.01" id='price' name="price"
                    ...
                    <div class="flex justify-end m-2 p-2">
                      <a href="{{route('admin.categories.index')}}" class="px-4 py-2 bg-indigo-500 hover:bg-red-700 rounded-lg text-white text-white">Back</a>
                    </div>
                  </div>
          </div>
        </div>
