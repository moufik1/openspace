    ...
    <div class="lg:flex">
        <div class="lg:w-1/2 xl:max-w-screen-sm">
            ...
            <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                <h2 class="text-center text-4xl text-b lg:text-center font-bold xl:text-5xl
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mt-8">
                            <div class="flex justify-between items-center">
                                ...
                                <div>
                                    @if (Route::has('password.request'))
                                    <a class="text-xs font-display font-semibold text-bold hover:text-black
                            ...
                            <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500 rounded-2xl" name="password" type="password" placeholder="Enter your password" required autocomplete="current-password">
                        </div>
                        <div class="block mt-4">
                            <label for="remember_me" class="inline-flex items-center">
